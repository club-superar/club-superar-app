...
export function LaunchSettingsForm({ helpInstagramUrl, redemptionsEnabled, ticketsEnabled }: { helpInstagramUrl: string; redemptionsEnabled: boolean; ticketsEnabled: boolean }) {
  ...
  return <form action={action} className="branding-admin-form">
    ...
    <label className="feature-toggle"><input name="ticketsEnabled" type="checkbox" value="true" defaultChecked={ticketsEnabled} /><span><strong>Habilitar lector de tickets</strong><small>Mientras esté apagado, la nueva pestaña Tickets mostrará “Próximamente”.</small></span></label>

...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ notice?: string }> }) {
  ...
  return (
    <main className="admin-shell">
      ...
      <section className="admin-panel admin-rewards-entry"><div><h2>Tickets de compra</h2><p>Revisá Facturas B pendientes y acreditá los puntos.</p></div><Link className="button primary" href="/admin/tickets">Revisar tickets</Link></section>
